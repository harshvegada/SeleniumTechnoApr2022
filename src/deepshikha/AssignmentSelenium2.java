...
public class AssignmentSelenium2 {
	...
	void testJavaScriptConfirmation() {
		...
		if (actualMessage.equals("Are you are doing your hoework regularly, Press Okay else Cancel!!")) {
			System.out.println("Test Pass!");
		} else {
			System.out.println("Test Fail!");
		}
	 ...
	 */
	void testJavaScriptConfirmationdismiss() {
		System.out.println("STEP- Click on Javascript confirmation button");
		driver.findElement(By.id("javascriptConfirmBox")).click();
		System.out.println("Switch to alert");
		Alert alert = driver.switchTo().alert();
		System.out.println("Get Dismiss Alert");
		alert.dismiss();
		...
		void checkAlertDemo(String firstName, String lastName, String companyName) {
			...
			System.out.println("Get Alert text");
			String actualMessage = alert.getText();
			if (actualMessage.equals("Deepshikha" + " name " + " Anurag" + " and" + " Globant ")) {
				System.out.println("Test pass");
			} else {
				System.out.println("Test fail");
			}
	...
	public static void main(String[] args) {
			AssignmentSelenium2 assignmentSelenium2 = new AssignmentSelenium2();
			assignmentSelenium2.launchBrowser("http://automationbykrishna.com");
			System.out.println("=======================Program1=========================");
			assignmentSelenium2.testAlert();
			System.out.println("=======================Program2=========================");
			assignmentSelenium2.testJavaScriptConfirmation();
			System.out.println("=======================Program3=========================");
			assignmentSelenium2.testJavaScriptConfirmationdismiss();
			System.out.println("=======================Program4=========================");
			assignmentSelenium2.checkAlertDemo("Deepshikha", "Anurag", "Globant");
			System.out.println("=======================Program5=========================");
			assignmentSelenium2.checkBasicForm("deepshikha1321@gmail.com", "bfsdthf56@56");
