...
public class Assignment2_JavaAlerts {
	...
	void program4() {
		...
		driver.findElement(By.id("UserFirstName")).sendKeys("Minal");
		System.out.println("STEP - Enter last name");
		driver.findElement(By.id("UserLastName")).sendKeys("Hake");
		...
		verifyAlertMessage(acceptAlert(), "Minal and Hake and Magic");
	}
