...
public class SAssignment1 {
	...
	public static void main(String[] args) {
		SAssignment1 sassignment1 = new SAssignment1();

		System.out.println("Step- Launch Chrome browser");
		sassignment1.launchChromeBrowser();
		System.out.println("Step- Load URL");
		sassignment1.loadUrl("http://automationbykrishna.com");

		// Positive scenario
		System.out.println("-----:Verify alert message for strong password:-----");
		sassignment1.loginTest("TGorde", "TGorde1234@", "Success!");

		// Negative scenario
		System.out.println("-----:Verify alert message for week password:-----");
		sassignment1.loginTest("TGorde", "TG", "Success!");
