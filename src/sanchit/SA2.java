...
public class SA2 {
	...
	public static void main(String[] args) {
		...
		// Program 2
		sa2.javaScriptConfirmationButtonOK();
		System.out.println("_________________________");

		// Program 3
		sa2.javaScrpitConfrimationButtonCancel();
		System.out.println("_________________________");

		// Program 4
		String nameInPrompt = "Sanchit";
		sa2.javaScrpitPromptButton(nameInPrompt);
		System.out.println("_________________________");

		// Program 5
		String firstN = "Sanchit";
		String lastN = "Kumar";
		String companyN = "MindTree";
		sa2.automateAlertDemo(firstN, lastN, companyN);
		System.out.println("_________________________");

		// Program 6
		String mail_ID = "sa@gmail.com";
		String passWord = "sa1234567";
		sa2.automateBasicForms(mail_ID, passWord);
