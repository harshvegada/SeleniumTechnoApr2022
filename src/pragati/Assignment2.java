...
{    
 ...
 public static void main(String[] args)
 {
	 ...
	 assignment2. examplejavascriptPrompt("pragati");
	 assignment2. examplejavascriptPromptForCancel("User cancelled the prompt.");
	 assignment2.testDemo("pragati","sawant","abcd");
	 assignment2. testBasicForms("pragatisawant0@gmail.com","abc123sfsf","You successfully clicked on it");
 }
