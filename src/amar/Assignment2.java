...
public class Assignment2 {
	...
	void verifyConfirmationButtonOK() {
		System.out.println("STEP - Click on javascript Confirmetion button");
		...
		System.out.println("STEP - Check the alert message\"Are you are doing your homework regularly, Press Okay else Cancel!!\"");
		verifyAlertMessage(expectedMessage, actualMessage);
		
		System.out.println("STEP - Click ok to accept the alert");
		alert.accept();
		
		System.out.println("STEP - Check that message appears\"You pressed OK!\"because OK button is clicked");
	...
	void verifyAlertDemoText(String firstName, String lastName, String companyName) {
		...
		System.out.println("Get alert text message");
		String actualMessage = alert.getText();
		String expectedMessage = firstName + " and " + " and " + companyName;
	...
	public static void main(String[] args) {
		...
		obj.basicElementsHandle();
		
		System.out.println("\nTestCase-1");
		obj.verifyAlertButton();
		
		System.out.println("\nTestCase-2");
		obj.verifyConfirmationButtonOK();
		
		System.out.println("\nTestCase-3");
		obj.verifyConfirmationButtonCancel();
		
		System.out.println("\nTestCase-4");
		obj.verifyJavascriptPromptOK("Amar");
		
		System.out.println("\nTestCase-5");
		obj.verifyJavascriptPromptCancel("Amar");
		
		System.out.println("\nTestCase-6");
		obj.verifyAlertDemoText("Amar", "Kadam", "WNS");
		
		System.out.println("\nTestCase-7");
		obj.verifyBasicFormText("kadamamar31.ak@gmail.com", "Amar987");
	}	
}
