...
public class Assignment2 {
	...
	void fastWait(int time){
	 ...
	 public static void main(String[] args){
		 ...
		 assignment2.exampleAlert();
		 assignment2.examplejavascriptConfirm("You pressed OK!"); 
		 assignment2.examplejavascriptConfirmForCancel("You pressed Cancel!");
		 assignment2. examplejavascriptPrompt("prachi");
		 assignment2. examplejavascriptPromptForCancel("User cancelled the prompt.");
		 assignment2.testDemo("prachi","jain","TCS");
		 assignment2. testBasicForms("jain.prachi2206@gmail.com","098765abcd","You successfully clicked on it");
	 }
}
