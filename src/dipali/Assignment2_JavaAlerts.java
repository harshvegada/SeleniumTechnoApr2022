...
public class Assignment2_JavaAlerts {
	...
	void program4() {
		...
		driver.findElement(By.id("UserFirstName")).sendKeys("Dipali");
		System.out.println("STEP - Enter last name");
		driver.findElement(By.id("UserLastName")).sendKeys("Patil");
		System.out.println("STEP - Enter company name");
		driver.findElement(By.id("UserCompanyName")).sendKeys("Reliable");
		System.out.println("STEP - Click on Submit button");
		driver.findElement(By.xpath("//button[@onclick='myFunctionPopUp()']")).click();
		verifyAlertMessage(acceptAlert(), "Dipali and Patil and Reliable");
	}

	void program5() {
		preRequisites("http://automationbykrishna.com/");
		System.out.println("STEP - Enter email address");
		driver.findElement(By.id("exampleInputEmail1")).sendKeys("kudavedipli28@gmail.com");
	...
	public static void main(String[] args) {
		Assignment2_JavaAlerts assignment2 = new Assignment2_JavaAlerts();
