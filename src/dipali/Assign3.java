...
public class Assign3 {
	...
	public static void main(String[] args) {
		Assign3 ass3 = new Assign3();
		ass3.launchChromeBrowserLoadFacebookUrl();
		...
		ass3.fillCreateNewAccountForm(firstN, lastN, emailOrPhoneNum, password, dayDOB, monthDOB, yearDOB, gender);
